			...
			<!-- main-sidebar -->
				...
				<div class="container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Home</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Newsletter</span>
							</div>
						</div>
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Newsletter</h4>
										...
										<table id="example" class="table key-buttons text-md-nowrap dataTable no-footer dtr-inline">
											...
											<tbody class="data">
                                                ...
                                                <tr>
                                                    ...
                                                    $table = base64_encode('newsletter');
                                                    ?>
