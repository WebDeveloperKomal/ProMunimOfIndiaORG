         ...
         <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
               <div class="d-flex">
                  ...
                  <span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Iternary</span>
               </div>
            </div>
               ...
               <div class="card mg-b-20">
                  <div class="card-header pb-0">
                     <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">Iternary</h4>
                        ...
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="exampleModalLongTitle">Add Iternary</h5>
                                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                 <span aria-hidden="true">×</span>
                                 </button>
                              </div>
                              <form action="<?= base_url('admin/save_iternary')?>" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="table-responsive">
                        <table id="example" class="table key-buttons text-md-nowrap dataTable no-footer dtr-inline">
                           ...
                           <tbody class="data">
                              <?php 
                                 $i=1;
                                 foreach($iternary as $row):?>
                              <tr>
                                 <td><?= $i;?></td>
                                 <td><?= $row->title?></td>
                                 <td><?php foreach($package as $p){if($p->id == $row->package){echo $p->title; }}?></td>
                                 <td><?= $row->desc?></td>
                              ...
                              <div class="modal fade" id="editmodal_<?= $row->id?>" aria-hidden="true">
                                 <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                     ...
                                     <div class="form-group">
                                       ...
                                       <select class="form-control" name="category" required>
                                           <option disabled selected>Select</option>
                                           <?php foreach($package as $p):?> 
                                           <option value="<?= $p->id?>" <?php if($p->id == $row->package){ echo 'selected'; }?>><?= $p->title?></option>
                                           <?php endforeach?>
                                       </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       <label>Description</label>
                                       <textarea class="form-control" id="editor_<?= $row->id?>" name="desc"><?= $row->desc?></textarea>
