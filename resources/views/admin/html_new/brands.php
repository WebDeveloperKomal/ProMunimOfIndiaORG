			...
			<!-- main-sidebar -->
				...
				<div class="container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Home</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Brands</span>
							</div>
						</div>
                                ...
                                <div class="modal fade" id="createModal" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?= base_url('admin/add_brands')?>" method="POST" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label>Brands</label>
                                                    <input type="text" name="brand" class="form-control" placeholder="Brands" required/>
                                                </div>
                                                <div class="form-group">
										...
										<table id="example" class="table key-buttons text-md-nowrap dataTable no-footer dtr-inline">
											...
											<tbody class="data">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row->brand?></td>
                                                    <td><img src="<?= base_url('upload/'.$row->logo)?>" width="100px" alt="<?= $row->brand?>"/></td>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="<?= base_url('admin/edit_brands/'.$id)?>" method="POST" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label>Car Type</label>
                                                    <select class="form-control" name="car_type">
                                                        ...
                                                        <?php foreach($car_type as $type):?>
                                                            <option <?php if($type->id == $row->id){ echo 'selected';}?> value="<?= $type->id?>"><?= $type->type?></option>
                                                        <?php endforeach?>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label>Brands</label>
                                                    <input type="text" name="brand" class="form-control" placeholder="Brands" value="<?= $row->brand?>" required/>
                                                </div>
                                                <div class="form-group">
