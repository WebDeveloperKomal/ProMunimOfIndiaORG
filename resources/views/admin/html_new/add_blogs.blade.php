                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="category" required>
                                                <option value="Press Release" <?php if(request()->segment('3')){if($blog->category == 'Press Release'){echo 'selected';}}?>>Press Release</option>
                                                <option value="Blogs" <?php if(request()->segment('3')){if($blog->category == 'Blogs'){echo 'selected';}}?>>Blogs</option>
                                            </select>
                                        </div>
                                        </div>
                                        <div class="col-md-12">
