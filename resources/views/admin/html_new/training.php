         ...
         <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
               <div class="d-flex">
                  ...
                  <span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Training</span>
               </div>
            </div>
               ...
               <div class="card mg-b-20">
                  <div class="card-header pb-0">
                     <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">Training</h4>
                     ...
                     <div class="modal fade" id="createModal" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                              ...
                              <form action="<?= base_url('admin/add_training')?>" method="POST" enctype="multipart/form-data">
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap dataTable no-footer dtr-inline">
                           ...
                           <tbody class="data">
                              ...
                              <tr>
                                 <td><?= $i;?></td>
                                 <td><?= $row->title?></td>
                                 <td><img src="<?= base_url('upload/'.$row->image)?>" width="100px" alt="<?= $row->image?>"/></td>
                                 <td><?= $row->desc?></td>
