         ...
         <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
               <div class="d-flex">
                  ...
                  <span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Hotels</span>
               </div>
            </div>
               ...
               <div class="card mg-b-20">
                  <div class="card-header pb-0">
                     <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">Hotels</h4>
                        <i class="mdi mdi-dots-horizontal text-gray"></i>
                     </div>
                     <a href="<?= base_url('admin/add_hotels')?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                     <!-- Modal -->
                  </div>
                  <div class="card-body">
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap dataTable no-footer dtr-inline">
                           ...
                           <tbody class="data">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <div class='btn btn-success'"><a class="text-white" href="<?= base_url('admin/add_hotels/'.base64_encode($row->id))?>"><i class='fa fa-edit'></i></a></div>
                                    <?php 
                                       $ids = $row->id;
                                       $id = base64_encode($ids);
                                       $table = base64_encode('hotels');
                                       ?>
