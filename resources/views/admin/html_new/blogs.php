						...
						<div class="col-xl-12">
							<div class="card mg-b-20">
								<div class="card-header pb-0">
                                    ...
                                    <a href="<?= base_url('admin/add_blogs')?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                                     <!-- Modal -->
                                </div>
								<div class="card-body">
										...
										<table id="example" class="table key-buttons text-md-nowrap dataTable no-footer dtr-inline">
											...
											<tbody class="data">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><div class='btn btn-success'><a class="text-white" href="<?= base_url('admin/add_blogs/'.base64_encode($row->id))?>"><i class='fa fa-edit'></i></a></div>
                                                    <?php 
                                                    $ids = $row->id;
