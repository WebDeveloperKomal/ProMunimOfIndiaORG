			...
			<div class="">
				...
				<div class="container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Home</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Add Zones</span>
							</div>
						</div>
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Add Zones</h4>
								...
								<div class="card-body">
                                    ...
                                    <?php endif?>
									<form method="POST" action="<?= base_url('admin/save_zones')?>" enctype='multipart/form-data'>
                                    <div class="row">
                                        <div class="col-md-12">
