...
.elementor-31 .elementor-element.elementor-element-430b65c {
    ...
    font-weight: 600!important;">Simplifying Your Accounting</p>
                         ...
                         <div class="row">
                     <div class="col-md-12">
                        <input type="hidden" name="_token" value="yDkCQP37Ndtc8dqcxxziJLzL51ahdu596qxTOgUN">                        
                        <div class="form-group">
                           <input type="text" id="business_name" name="business_name" placeholder="Login ID" required="">
                           <label style="float:right;
    font-size: 12px;">Get Login ID </label>
                        </div>
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                           <input type="text" id="owner_name" name="owner_name" placeholder="Password" required="">
                              <label style="float:right;
    font-size: 12px;">Forgot Password </label>
                        </div>
